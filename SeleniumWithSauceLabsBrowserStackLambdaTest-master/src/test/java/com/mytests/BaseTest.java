...
public class BaseTest {
	...
	public void setUp(String browserName, String platformName, String versionName,  Method name) {
		...
		sauceOpts.setCapability("username", "rohitso");
		sauceOpts.setCapability("accessKey", "326d0a3c-20b7-4230-bf75-1110695a1d9c");
		...
		//https://rohitso:326d0a3c-20b7-4230-bf75-1110695a1d9c@ondemand.us-west-1.saucelabs.com:443/wd/hub
		try {
